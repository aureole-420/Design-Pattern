...
public class BallGUI<TDropListItem, TPSDropListItem> extends JFrame {
	 ...
	 */
	private IView2ModelControlAdapter<TDropListItem, TPSDropListItem> _view2ModelControlAdpt; // = IView2ModelControlAdapter<Object>.NULL_OBJECT;
	...
	/**
	 * The subpanel consisting buttons regarding paint strategy.
	 */
	private JPanel _pnlPaintStrategy;

	/**
	 * Click the button to add a Paint Strategy to droplist.
	 */
	private JButton _btnAddPaintStrategy;

	/**
	 * Read in the shortened name of a paintStrategy.
	 */
	private JTextField txtPaintStrategyName;

	/**
	 * Drop list for paint strategy factory.
	 */
	private JComboBox<TPSDropListItem> _listPSDL;
	 ...
	 */
	public BallGUI(IView2ModelControlAdapter<TDropListItem, TPSDropListItem> _view2ModelControlAdpt,
			IView2ModelPaintAdapter iVew2ModelPaintAdapter) {
	...
	private void initGUI() {
		...
		btnMakeBall.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (_list1DL.getSelectedIndex() == -1 || _listPSDL.getSelectedIndex() == -1) {
					System.out.println("Please select updateStrategy and/or paintStrategy before making balls!");
					return;
				}
		...
		_btnCombineStrategy.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (_list1DL.getSelectedIndex() == -1 || _list2DL.getSelectedIndex() == -1) {
					System.out.println("Please select TWO update strategies to combine!");
					return;
				}
		...
		_btnMakeSwitcher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (_listPSDL.getSelectedIndex() < 0) {
					return;
				}
		...
		_btnSwitch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (_list1DL.getSelectedIndex() == -1) {
		...
		txtPaintStrategyName.setText("BirdSheepImage");
